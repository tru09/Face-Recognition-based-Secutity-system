# -*- coding: utf-8 -*-
"""LBPH_recognition.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/github/Shashank2909/Project/blob/backup/project/opencv/LBPH_recognition.ipynb
"""
...
def add_person():
    ...
    if not os.path.exists(folder):                                          #Find the if the data for the given person already exists
        ...
        while counter < 51:
            ...
            profile_faces = profile_cascade.detectMultiScale(frame,1.3,4)                        #Finding the co-ordinates of all faces in the frame
